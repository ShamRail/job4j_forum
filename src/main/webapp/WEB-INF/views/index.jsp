...
<div class="container mt-3">
    ...
    <br>
    <div class="row">
        <a class="btn btn-primary" href="/theme/create" role="button">Создать тему</a>
    </div>
    <br>
    <div class="row">
        <table class="table">
            ...
            <c:forEach items="${themes}" var="theme">
                <tr>
                    <td>
                        <a href='<c:url value="/theme/create?id=${theme.id}"/>'>
                            <i class="fa fa-edit mr-3"></i>
                        </a>
                    </td>
                    <td>
                        <a href="/theme/${theme.id}/post">
                            <c:out value="${theme.name}"/>
                        </a>
                    </td>
                    <td><c:out value="${theme.description}"/></td>
                    <td><c:out value="${theme.formattedDateTime()}"/></td>
                    <td><c:out value="${theme.author.username}"/></td>
                    <td>
